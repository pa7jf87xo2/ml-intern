...
> **Personal note:** I've found `--max-iterations 50` to be a good sweet spot for most tasks — enough headroom without runaway loops. The default of 300 can rack up API costs quickly on complex prompts.
